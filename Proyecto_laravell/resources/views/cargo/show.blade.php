    ...
    <main class="page">
        ...
        <section class="contenedor-content">
            ...
            <section class="content">
                ...
                <form class="contenedor-hoja-vida" action="{{route('cargo.update', ['id' => $cargo -> id])}}" method="POST">
                    @csrf
                    @method('put')
                    ...
                    <section class="primera-linea">
                        ...
                        <section class="linea-1">
                            ...
                            <article class="cargo">
                                ...
                                <input class="input" type="text" name="cargo" placeholder="" value="{{ old('cargo', $cargo -> cargo)}}" />
                            </article>
