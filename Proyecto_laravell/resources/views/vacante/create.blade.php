            ...
            <form class="formulario" action="{{route('vacante.store')}}" method="POST">
                        ...
                        <article class="grid-1">
                            <article class="contenedor-codigo">
                                <label for="">
                                    ...
                                    <input id="" class="input" type="text" name="codigo" value="{{old('codigo')}}">
                                </label>
                            </article>
                            ...
                            <article class="contenedor-num_vacante">
                                <label for="">
                                    ...
                                    <input class="input" type="text" name="num_vacante" value="{{old('num_vacante')}}">
                                </label>
                            </article>
                            ...
                            <article class="contenedor-meses_experiencia">
                                <label for="">
                                    ...
                                    <input class="input" type="text" name="meses_experiencia" value="{{old('meses_experiencia')}}">
                                </label>
                            </article>
                ...
                <article class="contenedor-educacion-requerida">
                    ...
                    <article class="parrafo">
                        <h1>Atencion</h1>
                        <p>En este espacio podras colocar el nivel de educacion que requiere la vacante con una descripcion de esta, el campo de puntuacion sera la ponderacion que tendra el candidato si cumple con el nivel de educacion que se requiere</p>
                    </article>
                    ...
                    <article class="grid">
                        ...
                        <article class="contenedor-puntos">
                            ...
                            <input class="puntos" type="number" name="puntos" value="{{old('puntos')}}">
                        </article>
                    </article>
