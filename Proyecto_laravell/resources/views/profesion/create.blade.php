    ...
    <main class="page">
        ...
        <section class="contenedor-content">
            ...
            <section class="content">
                ...
                <form class="contenedor-hoja-vida" action="{{route('profesion.store', ['id' => $idInstructor])}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    @forelse($profesiones as $profesion)
                        <article class="ocupacion">
                            <article class="parte-1">
                                ...
                                <a href="">{{$profesion -> titulado}}</a>
                            </article>

                            <article class="parte-2">
                                <form action="{{route('profesion.destroy', ['id' => $profesion -> id])}}" method="POST">
                                    @csrf
                                    @method('delete')
                                    <button class="buttom">
