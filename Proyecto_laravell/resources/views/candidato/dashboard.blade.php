        ...
        <section class="content">
            ...
            <section class="segunda-columna">
                ...
                <article class="contenedor-informacion">
                        ...
                        <article class="contenedor-instructor">
                            ...
                            <article class="contenedor-opciones">
                                <form class="formulario"
                                    action="{{ route('user.destroy', ['id' => $candidato->user_id]) }}"
                                    method="POST">
                                    @csrf
                                ...
                                <article class="rol">
                                    <form class="formulario-2"
                                        action="{{ route('update.rol', ['id' => $candidato->user_id]) }}"
                                        method="POST">
                                        @csrf
                    ...
                    @empty
                        <h3 class="empty">No hay ningun candidato registrado</h3>
                    @endforelse
                </article>
            </section>
        </section>
