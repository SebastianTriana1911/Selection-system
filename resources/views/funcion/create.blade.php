            ...
            <section class="content">
                <article class="contenedor-titulo">
                    <article class="contenedor">
                        ...
                        <h1 class="titulo-principal">Formulario para crear funciones</h1>
                    </article>
                    <h1 class="linea"></h1>
                </article>

                <form class="contenedor-hoja-vida" action="{{ route('funcion.store', ['id' => $ocupaciones->id]) }}"
                    method="POST">
                    @csrf

                    <article class="contenedor-encabezado">
                        <h1 class="encabezado">Funcion de la ocupacion con codigo {{ $ocupaciones->codigo }}</h1>
                    </article>
