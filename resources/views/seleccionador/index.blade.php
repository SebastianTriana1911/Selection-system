        ...
        <section class="contenedor-content">
            ...
            <article class="recuadro-menu">
                ...
                <article class="cuadro-2">
                    ...
                    <article class="contenedor-descripcion">
                        <p>En este campo podras visualizar todas las vacantes creadas en la empresa, por consiguiente podras observar los candidatos postulados para llevarlos de la mano con su proceso de seleccion.</p>
                    </article>
