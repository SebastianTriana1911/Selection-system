            ...
            <section class="segunda-columna">
                ...
                <article class="contenedor-informacion">
                    @forelse($supers as $super)
                            ...
                            <article class="contenedor-instructor">
                                ...
                                <article class="contenedor-opciones">
                                    <form class="formulario"
                                        action="{{ route('user.destroy', ['id' => $super->user_id]) }}" method="POST">
                                        @csrf
                                    ...
                                    <article class="rol">
                                        <form class="formulario-2"
                                            action="{{ route('update.rol', ['id' => $super->user_id]) }}"
                                            method="POST">
                                            @csrf
                        ...
                        @endif
                    @empty
                        <h3 class="empty">No hay ningun administrador registrado</h3>
                    @endforelse
                </article>
            </section>
        </section>
